        ...
        div(
          ...
          div(
            ...
            p("Source codes can be accessed at ", 
              ...
              tags$a(href = "https://github.com/wangshisheng/Ontolomics-P/blob/master/UserManual.pdf", "User Manual", target = "_blank"), "."),
            p("Key features include:"),
            tags$ul(
              tags$li("Real-time results with an intuitive user interface."),
              tags$li("Support for local large language models in conversation modules."),
              tags$li("Comprehensive tools for omics data analysis.")
            )
          ),
...
server <- shinyServer(
  function(input, output, session) {
    ...
    observeEvent(input$button_module1, {
      updateNavbarPage(session, "navbarid",
                       selected = "functionspanel")
    })
          ...
          column(
            ...
            div(
              ...
              div(
                ...
                #tags$img(src = "SurvivalPlot_LLM.png",alt = "Survival Plot", 
                #width="200px",height = "200px"))
              ),
              div(
                style = "margin-top:15px; text-align:center; font-size:120%; font-weight:bold; color:#1f2937;",
...
Act as a senior bioinformatician. Your task is to refine the following R code sequence for clarity, reproducibility, and robustness.
...
3. **Code Execution:**  
   - All code must be executable as a single, ordered script without manual intervention.  
...
"
          ...
          oneclick_user_message1 <<- paste0(oneclick_user_message1, "OUTPUT FORMAT:\n# Step 1: [Short Step Name]\n[refined R code]\n# Step 2: [Short Step Name]\n[refined R code]\n...\n\nREFERENCE CODES:\n\n")
